...
struct FlippingCardDishPickerView: View {
    ...
    var body: some View {
        NavigationView {
            ...
            .navigationTitle(localization.localizedString(for: "pick_dishes_for_cards"))
...
#Preview {
    FlippingCardDishPickerView(selectedDishes: .constant([]))
}

// MARK: - Selectable Dish Card
struct FlippingSelectableDishCard: View {
    let dish: Dish
    let isSelected: Bool
    let canSelect: Bool
    let onTap: () -> Void
